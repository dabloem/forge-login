== forge-login
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The forge-login addon enables blah blah...)
...
----
<dependency>
   <groupId>org.forge.login</groupId>
   <artifactId>forge-login</artifactId>
